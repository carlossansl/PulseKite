 ...
 * This file demonstrates how to integrate Pulsekite with a web frontend
 */

// For React/Vue/Angular applications
export class PulsekiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PulsekiteClient(provider, contractAddress);
